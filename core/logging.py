...
_SAFE_LOG_FIELDS = {"doc_id", "chunk_id", "error_type", "reason", "stage", "status", "size_bytes", "objects", "count"}
...
def log_event(logger: logging.Logger, operation: str, **fields: Any) -> None:
    ...
    safe = {key: value for key, value in fields.items() if key in _SAFE_LOG_FIELDS}
